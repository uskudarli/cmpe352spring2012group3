...
public final class FeedAdapter extends ArrayAdapter<Feed> {
	...
	public View getView(final int position, final View convertView, final ViewGroup parent) {
		...
		viewHolder.nameView.setText(feed.getName());		
		viewHolder.contentView.setText(feed.getContent());
	...
	private ViewHolder getViewHolder(final View workingView) {
		...
		if(null == tag || !(tag instanceof ViewHolder)) {
			...
			viewHolder.contentView = (TextView) workingView.findViewById(R.id.content);
